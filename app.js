const units = [
  ...
  },
  {
    ...
    mustKnow: [
      ...
      "גודמן על מוניטיזציה: להפוך הגנה על הקשב להזדמנות עסקית במקום להרוויח מגניבת קשב.",
    ],
...
const coverage = [
  ...
  ["גודמן - פרק 4", "דורש בדיקה", "ה-PDF נסרק כתמונה וחילוץ הטקסט החזיר 0 תווים. באתר שולבה הטענה מתוך המצגת וקובץ TWS, אך כדאי לעיין בקובץ המקורי לשאלות עומק."],
  ["דף פעילות פתיחה שיעור 10", "דורש בדיקה", "ההנחיות מפנות לדף פעילות, אך לא נמצא כקובץ נפרד. המצגת כוללת דוגמאות, והאתר מוסיף שאלות יישום."],
  ["דף עבודה על קיילי/רולניק", "חלקי", "הכתבה והסיכום קיימים; אם היה דף עבודה נפרד מהכיתה, הוא לא הופיע ברשימת הקבצים."],
  ["תרגום TED לעברית", "חלקי", "הקובץ קיים אך חילוץ הטקסט שלו רועש. תוכן טריסטן האריס שולב לפי המצגת והסיכום."],
];
  ...
  views.dashboard.innerHTML = `
    <div class="hero-grid">
      ...
      <div class="panel">
        ...
        <p><strong>שני דברים לבדיקה:</strong> פרק גודמן הוא PDF תמונה ללא טקסט חילוץ, ודף פעילות פתיחה לשיעור 10 לא הופיע כקובץ נפרד.</p>
      </div>
    </div>
